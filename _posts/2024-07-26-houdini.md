...
1. **Feedback each iteration vs Merge each iteration**
    ...
    - **Comparision**
        ...
        | -------- | -------- | ----- |
        | Example | ![foreach_feedback](../assets/houdini/foreach_001.jpg) | ![foreach_feedback](../assets/houdini/foreach_002.jpg) |
    ...
    - Speicific **example** of **Feedback each iteration**
        ...
        | before | after |
        | ------ | ----- |
        | ![ex_feedback_iteration](../assets/houdini/foreach_ex_001.jpg) | ![ex_feedback_iteration](../assets/houdini/foreach_ex_002.jpg) |
